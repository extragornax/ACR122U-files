...
void Sending()
{
	...
	for( index = 0; index <= dataLen; index++ )
	{
		...
		SendBuff[8+index] = (int)tempdata[index];
...
CActiveSampleDlg::CActiveSampleDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CActiveSampleDlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CActiveSampleDlg)
	//}}AFX_DATA_INIT
	m_hIconBig   = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
	m_hIconSmall = AfxGetApp()->LoadIcon(IDR_SMALLICON);
}

void CActiveSampleDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CActiveSampleDlg)
...
BEGIN_MESSAGE_MAP(CActiveSampleDlg, CDialog)
	//{{AFX_MSG_MAP(CActiveSampleDlg)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	...
	ON_BN_CLICKED(IDC_BUTTON5, Onzreset)
	ON_BN_CLICKED(IDC_BUTTON6, OnQuit)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CActiveSampleDlg message handlers

BOOL CActiveSampleDlg::OnInitDialog()
{
...
void CActiveSampleDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CActiveSampleDlg::OnQueryDragIcon()
{
	return (HCURSOR) m_hIconSmall;
}

void CActiveSampleDlg::OnInit() 
{
	...
	index = cbReader.FindStringExact( -1, "ACS ACR122 1" );
...
void CActiveSampleDlg::OnSetMode() 
{
	char tempstr[262];
...
void CActiveSampleDlg::Onzreset() 
{
